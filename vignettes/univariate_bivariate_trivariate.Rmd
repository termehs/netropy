...
redundancy(dyad.var)
```
To illustrate an example with redundancy, we use the dataframe `att.var` with node attributes as described and created in [variable domains and data editing](variable domains.html). Note however that we now keep the variable `senior` in this dataframe:
